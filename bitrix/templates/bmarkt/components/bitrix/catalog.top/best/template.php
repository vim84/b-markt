...
elseif ($USER->isAdmin())
	echo '<div class="warning"><b>Этот текст видят только администраторы</b>. Тут блок "Лучший товар". Надо просто отметить галочками лучшие товары.</div>';
?>