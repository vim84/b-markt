...
<table class="bx-im-fullscreen-table">
	<tr>
		<td class="bx-im-fullscreen-td1" height="15%">
			...
			<div class="bx-im-fullscreen-back"><a href="/" class="bx-im-fullscreen-back-link"><?=GetMessage('IM_FULLSCREEN_BACK')?></a></div>
		</td>
	</tr>
	<tr>
...
<script type="text/javascript">
	document.title = '<?=GetMessage('IM_FULLSCREEN_TITLE')?>';
	BX.desktop.init();
